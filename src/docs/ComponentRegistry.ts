...
function getButtonExample() {
  return React.createElement('div', { className: 'p-8 space-y-8' },
    React.createElement('div', null,
      React.createElement('h2', { className: 'text-2xl font-bold mb-4' }, 'Button Variants'),
      React.createElement('div', { className: 'flex flex-wrap gap-4' },
        React.createElement('button', { className: 'px-4 py-2 bg-accent-500 text-white rounded-lg hover:bg-accent-600' }, 'Primary'),
        React.createElement('button', { className: 'px-4 py-2 bg-gray-100 text-gray-900 rounded-lg hover:bg-gray-200' }, 'Secondary'),
        React.createElement('button', { className: 'px-4 py-2 border border-gray-300 bg-white text-gray-700 rounded-lg hover:bg-gray-50' }, 'Outline'),
        React.createElement('button', { className: 'px-4 py-2 bg-transparent text-gray-700 rounded-lg hover:bg-gray-100' }, 'Ghost')
      )
    )
  )
}
...
export const componentDocs: ComponentDoc[] = [
  ...
  },
  {
    ...
    examples: React.createElement('div', { className: 'p-8 space-y-4 max-w-md' },
  ...
  },
  {
    ...
    examples: React.createElement('div', { className: 'p-8 space-y-4' },
      React.createElement('div', { className: 'bg-white border border-gray-200 rounded-xl p-4' },
        React.createElement('h3', { className: 'text-lg font-semibold mb-2' }, 'Card Title'),
        React.createElement('p', { className: 'text-gray-600' }, 'This is a card with content.')
      ),
      React.createElement('div', { className: 'bg-white shadow-soft rounded-xl p-4' },
        React.createElement('h3', { className: 'text-lg font-semibold mb-2' }, 'Elevated Card'),
        React.createElement('p', { className: 'text-gray-600' }, 'This card has a shadow.')
      )
    ),
    props: [
      {
  ...
  },
  {
    ...
    examples: React.createElement('div', { className: 'p-8 space-y-4' },
      React.createElement('div', { className: 'flex items-center space-x-4' },
        React.createElement('div', { className: 'w-10 h-10 bg-gray-200 rounded-full flex items-center justify-center' },
          React.createElement('span', { className: 'text-gray-600 font-medium' }, 'JD')
        ),
        React.createElement('div', { className: 'w-12 h-12 bg-gray-200 rounded-full flex items-center justify-center' },
          React.createElement('span', { className: 'text-gray-600 font-medium' }, 'JS')
        ),
        React.createElement('div', { className: 'w-16 h-16 bg-gray-200 rounded-full flex items-center justify-center' },
  ...
  },
  {
    ...
    examples: React.createElement('div', { className: 'p-8 space-y-4' },
      React.createElement('h1', { className: 'text-4xl font-bold text-gray-900' }, 'Heading 1'),
      React.createElement('h2', { className: 'text-3xl font-bold text-gray-900' }, 'Heading 2'),
      React.createElement('h3', { className: 'text-2xl font-semibold text-gray-900' }, 'Heading 3'),
      React.createElement('p', { className: 'text-lg text-gray-600' }, 'Subtitle text'),
      React.createElement('p', { className: 'text-base text-gray-900' }, 'Body text'),
      React.createElement('span', { className: 'text-sm text-gray-500' }, 'Caption text')
    ),
    props: [
      {
        name: 'variant',
  ...
  },
  {
    ...
    examples: React.createElement('div', { className: 'p-8 space-y-4' },
      React.createElement('div', { className: 'bg-white border border-gray-200 rounded-xl p-6 max-w-md' },
        React.createElement('h3', { className: 'text-xl font-semibold mb-4' }, 'Modal Example'),
        React.createElement('p', { className: 'text-gray-600 mb-4' }, 'This is an example of a modal dialog.'),
        React.createElement('div', { className: 'flex justify-end space-x-3' },
          React.createElement('button', { className: 'px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50' }, 'Cancel'),
          React.createElement('button', { className: 'px-4 py-2 bg-accent-500 text-white rounded-lg hover:bg-accent-600' }, 'Confirm')
        )
      )
    ),
    props: [
  ...
  },
  {
    ...
    examples: React.createElement('div', { className: 'p-8 space-y-4' },
      React.createElement('nav', { className: 'bg-white border-b border-gray-200 px-4 py-3' },
        React.createElement('div', { className: 'flex items-center justify-between' },
          React.createElement('div', { className: 'flex items-center' },
            React.createElement('span', { className: 'text-xl font-bold' }, 'Logo')
          ),
          React.createElement('div', { className: 'hidden md:flex space-x-4' },
            React.createElement('a', { href: '#', className: 'text-gray-600 hover:text-gray-900' }, 'Home'),
            React.createElement('a', { href: '#', className: 'text-gray-600 hover:text-gray-900' }, 'About'),
            React.createElement('a', { href: '#', className: 'text-gray-600 hover:text-gray-900' }, 'Contact')
          ),
