...
import React, { useRef, useContext, useDebugValue, createElement, forwardRef, useEffect, useState, Children, isValidElement, cloneElement, createContext } from 'react';
...
function Card({ children, variant = 'default', padding = 'md', rounded = false, className, ...props }) {
    return (jsx("div", { className: cn('transition-all duration-200', rounded ? 'rounded-full' : 'rounded-2xl', variantClasses$2[variant], paddingClasses[padding], className), ...props, children: children }));
}
...
const Input = forwardRef(({ type = 'text', placeholder, value, onChange, disabled = false, error = false, size = 'md', rounded = false, neumorphic = false, className, ...props }, ref) => {
    ...
    return (jsx(StyledInput, { ref: ref, type: type, placeholder: placeholder, value: value, onChange: handleChange, disabled: disabled, "$size": size, "$rounded": rounded, "$neumorphic": neumorphic, "$error": error, className: className, ...props }));
});
...
function Modal({ children, isOpen, onClose, title, size = 'md', className, ...props }) {
    ...
    if (!isOpen)
        return null;
    return (jsxs("div", { className: "fixed inset-0 z-50 flex items-center justify-center", children: [jsx("div", { className: "absolute inset-0 bg-black bg-opacity-50 transition-opacity", onClick: onClose }), jsxs("div", { className: cn('relative bg-neumorphism-background rounded-2xl w-full mx-4 max-h-[90vh] overflow-y-auto', sizeClasses$2[size], className), ...props, children: [title && (jsxs("div", { className: "flex items-center justify-between p-6 border-b border-gray-200", children: [jsx("h2", { className: "text-xl font-semibold text-gray-900", children: title }), jsx("button", { onClick: onClose, className: "p-1 text-gray-400 hover:text-gray-600 transition-colors", children: jsx("svg", { className: "w-6 h-6", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M6 18L18 6M6 6l12 12" }) }) })] })), jsx("div", { className: "p-6", children: children })] })] }));
}

function Navbar({ logo, links = [], actions, className, ...props }) {
    const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false);
    return (jsxs("nav", { className: cn('bg-neumorphism-background shadow-neumorphism-card sticky top-0 z-40', className), ...props, children: [jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: jsxs("div", { className: "flex justify-between items-center h-16", children: [jsx("div", { className: "flex-shrink-0", children: logo }), jsx("div", { className: "hidden md:block", children: jsx("div", { className: "ml-10 flex items-baseline space-x-4", children: links.map((link, index) => (jsx("a", { href: link.href, className: cn('px-3 py-2 rounded-md text-sm font-medium transition-all duration-200', link.active
                                        ? 'bg-gradient-to-r from-purple-400 to-purple-600 text-white'
                                        : 'text-gray-600 hover:bg-gradient-to-r hover:from-purple-400 hover:to-purple-600 hover:text-white'), children: link.label }, index))) }) }), jsx("div", { className: "hidden md:block", children: jsx("div", { className: "ml-4 flex items-center space-x-4", children: actions }) }), jsx("div", { className: "md:hidden", children: jsxs("button", { onClick: () => setIsMobileMenuOpen(!isMobileMenuOpen), className: "inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-accent-500", children: [jsx("span", { className: "sr-only", children: "Open main menu" }), isMobileMenuOpen ? (jsx("svg", { className: "block h-6 w-6", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M6 18L18 6M6 6l12 12" }) })) : (jsx("svg", { className: "block h-6 w-6", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M4 6h16M4 12h16M4 18h16" }) }))] }) })] }) }), isMobileMenuOpen && (jsx("div", { className: "md:hidden", children: jsxs("div", { className: "px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-neumorphism-background border-t border-gray-200", children: [links.map((link, index) => (jsx("a", { href: link.href, className: cn('block px-3 py-2 rounded-md text-base font-medium transition-all duration-200', link.active
                                ? 'bg-gradient-to-r from-purple-400 to-purple-600 text-white'
                                : 'text-gray-600 hover:bg-gradient-to-r hover:from-purple-400 hover:to-purple-600 hover:text-white'), onClick: () => setIsMobileMenuOpen(false), children: link.label }, index))), actions && (jsx("div", { className: "pt-4 pb-3 border-t border-gray-200", children: jsx("div", { className: "flex items-center space-x-4", children: actions }) }))] }) }))] }));
}

const Switch = forwardRef(({ checked = false, onChange, disabled = false, className = '', id, ...props }, ref) => {
    const handleChange = (e) => {
        onChange?.(e.target.checked);
    };
    const inputId = id || `switch-${Math.random().toString(36).substr(2, 9)}`;
    return (jsxs("div", { className: cn('relative w-[150px] h-[60px] bg-[rgb(236_240_243)] rounded-[50px]', 'shadow-[inset_6px_6px_4px_#d1d9e6,inset_-6px_-6px_4px_#ffffff]', className), ...props, children: [jsx("input", { ref: ref, id: inputId, type: "checkbox", className: "hidden", checked: checked, onChange: handleChange, disabled: disabled }), jsx("label", { htmlFor: inputId, className: "absolute top-1/2 left-0 w-full h-full -translate-y-1/2 rounded-[50px] overflow-hidden cursor-pointer", children: jsx("div", { className: cn('absolute w-[80px] h-[50px] rounded-[50px] top-[5px] left-[5px]', 'bg-gradient-to-br from-[#d2d2d2] to-[#ffffff]', 'shadow-[-3px_-3px_4px_#ffffff,3px_3px_4px_#c8c8c8]', 'transition-all duration-300 ease-in-out', 'flex items-center justify-start pl-[10px]', checked && 'left-[65px] bg-gradient-to-tl from-[#ffffff] to-[#d2d2d2]'), children: jsx("div", { className: cn('w-[10px] h-[10px] rounded-full transition-all duration-300 ease-in-out', disabled
                            ? 'bg-[#808080]'
                            : checked
...
function CirclePlate({ children, variant = 'primary', size = 'md', className, ...props }) {
    return (jsx("div", { className: cn('inline-flex items-center justify-center font-medium rounded-full transition-all duration-200', sizeClasses$1[size], variantClasses$1[variant], className), ...props, children: children }));
}
...
function Typography({ children, variant = 'body', color = 'primary', weight, className, ...props }) {
    ...
    return (jsx(Element, { className: cn(variantClasses[variant], colorClasses[color], weight && weightClasses[weight], className), ...props, children: children }));
}
...
const FormField = forwardRef(({ label, error, required = false, className, children, htmlFor }, ref) => {
    ...
    return (jsxs("div", { ref: ref, className: cn('space-y-2', className), children: [label && (jsxs("label", { htmlFor: fieldId, className: "block text-sm font-medium text-gray-700", children: [label, required && jsx("span", { className: "text-red-500 ml-1", children: "*" })] })), enhancedChildren, error && (jsx("p", { className: "text-sm text-red-600", children: error }))] }));
});
...
function NeumorphicProvider({ children }) {
    return (jsxs(Fragment, { children: [jsx(NeumorphicGlobalStyle, {}), children] }));
}
...
export { Avatar, Button, Card, CirclePlate, DocGenerator, FormField, Input, Modal, Navbar, NeumorphicProvider, Switch, Textarea, ThemeProvider, Typography, cn, componentDocs, defaultTheme, getAllComponents, getComponent, registerComponent, useTheme };
