...
function Button({ children, variant = 'primary', size = 'md', disabled = false, onClick, type = 'button', className, ...props }) {
    ...
    if (isGradient) {
        return (jsx("button", { type: type, disabled: disabled, onClick: onClick, className: clsx(variantClasses$3[variant], disabled && 'opacity-50 cursor-not-allowed', className), ...props, children: jsx("span", { children: children }) }));
    }
...
const Input = forwardRef(({ type = 'text', placeholder, value, onChange, disabled = false, error = false, size = 'md', rounded = false, neumorphic = false, className, ...props }, ref) => {
    ...
    return (jsx("input", { ref: ref, type: type, placeholder: placeholder, value: value, onChange: handleChange, disabled: disabled, className: inputClasses, ...props }));
});
...
const Switch = forwardRef(({ checked = false, onChange, disabled = false, className = '', id, ...props }, ref) => {
    ...
    return (jsxs("div", { className: clsx('switch-container', className), ...props, children: [jsx("input", { ref: ref, id: inputId, type: "checkbox", className: "toggle-checkbox", checked: checked, onChange: handleChange, disabled: disabled }), jsx("label", { htmlFor: inputId, className: "switch", children: jsx("div", { className: clsx('toggle', checked && 'toggle-checked'), children: jsx("div", { className: clsx('led', checked && 'led-checked', disabled && 'led-disabled') }) }) })] }));
});
...
function CirclePlate({ children, variant = 'primary', size = 'md', className, ...props }) {
    return (jsx("div", { className: clsx('inline-flex items-center justify-center font-medium rounded-full transition-all duration-200', sizeClasses$1[size], variantClasses$1[variant], className), ...props, children: children }));
}
...
function Typography({ children, variant = 'body', color = 'primary', weight, className, ...props }) {
    ...
    return (jsx(Element, { className: clsx(variantClasses[variant], colorClasses[color], weight && weightClasses[weight], className), ...props, children: children }));
}
