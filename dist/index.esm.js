...
const FormField = forwardRef(({ label, error, required = false, className, children, htmlFor }, ref) => {
    return (jsxs("div", { ref: ref, className: cn('space-y-2', className), children: [label && (jsxs("label", { htmlFor: htmlFor, className: "block text-sm font-medium text-gray-700", children: [label, required && jsx("span", { className: "text-red-500 ml-1", children: "*" })] })), children, error && (jsx("p", { className: "text-sm text-red-600", children: error }))] }));
});
